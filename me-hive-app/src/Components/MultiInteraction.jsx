...
export default class MultiInteraction extends React.Component {
  ...
  createInteraction(){
    ...
    infohandler.addInteractions(this.props.userID, this.props.contactID, this.newInteraction)
    .then((res) => {
        //console.log(res);
        this.props.onClose();
    })
  ...
  return ( 
    <div className="modal">
      <div className="modal-content">
        ...
        <h3 className="modal-title">Interaction with Selected Contacts</h3>
        ...
        <div className="modal-body">
          ...
          <textarea name="text" rows="14" cols="10" wrap="soft" onChange={evt => this.updateDetails(evt)}> </textarea>
        </div>
